...
const METHODS = [
  { id: 'google', label: 'Google Authenticator', desc: 'Enter the 6-digit code from your app' },
  { id: 'ms', label: 'Microsoft Authenticator', desc: 'Approve the push notification' },
  { id: 'sms', label: 'SMS OTP', desc: 'Code sent to registered mobile' },
]

...
const BRANCH_ITEMS = [
  ...
  { label: 'Enter Data', path: '/branch/data-entry', icon: <PencilLine size={16} />, badge: '0/6' },
...
const REGIONAL_ITEMS = [
  ...
  { label: 'Pending Approvals', path: '/regional/dashboard', icon: <Hourglass size={16} />, badge: 3 },
...
const HO_ITEMS = [
  ...
  { label: 'Analytics & Governance', path: '/ho/analytics', icon: <ChartBar size={16} /> },
